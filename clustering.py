...
if __name__ == "__main__":
    clustering = Clustering("/Users/venkatbiyyapu/Desktop/IR/Project/Queries/asian dance.json")
    result, count = clustering.get_clusters_results("Flat_Clustering")
    print(result, count)
    # with open("output_asian4.json", "w") as f:
    #     json.dump(result, f, indent=4)  # Use json.dump instead of json.dumps
